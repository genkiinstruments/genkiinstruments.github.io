...
Functions](/wave-for-music/functions/click)).
...
3. In Softwave solo the function you want to map. 4. Create an →Instrument
...
3. In Softwave solo the function you want to map. 4. Create an →Audio Track← in
