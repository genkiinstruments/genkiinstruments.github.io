...
A simple API is available for developers. [Check out the documentation](https://github.com/genkiinstruments/genki-wave) and reach out to us at wave@genkiinstruments.com if you have any further questions.
